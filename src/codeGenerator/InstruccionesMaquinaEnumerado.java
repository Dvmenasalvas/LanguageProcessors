 ...
 */
public enum InstruccionesMaquinaEnumerado {
    // Instrucciones aritm�ticas, l�gicas y relacionales de la m�quina-P
    ADD,
    SUB,
    MUL,
    DIV,
    ...
    // Instrucciones de carga y almacenamiento de la m�quina-P
    LDO,
    ...
    CHK,//comprobaci�n de que los �ndices est�n en rango
    ...
    //ESTAS NO EST�N EN LA LISTA DEL PDF
    DPL,
    LDD,
    SLI,
    ...
    //direcci�n relativa de la variable en su marco respectivamente.
    ...
    MST, //establece enlaces est�tico y din�mico, guarda el registro EP del que lo llama y deja SP para comenzar el paso de par�metros
    CUP,//cup establece el nuevo valor de MP, salva la direcci�n de retorno y salta al procedimiento llamado
    SSP, //actualiza SP al final de la parte est�tica
    SEP, //establece el registro EP y comprueba que no choquen pila y mont�n
    ENT,
    RETF,
    RETP, //ejecuta la secuencia de terminaci�n de un procedimiento
